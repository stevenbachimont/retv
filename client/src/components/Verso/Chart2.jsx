...
function Chart2() {
    ...
    const data1 = (canvas) => {
        ...
        gradientStroke1.addColorStop(1, "rgba(175,0,200,0.73)");
        gradientStroke1.addColorStop(0.4, "rgba(175,0,200,0.71)");
            ...
            datasets: [
                {
                    ...
                    pointRadius: 2,
                    data: [2000, 4000, 2000, 1300, 2000, 1100, 1030, 1300, 1078, 100, 110, 100],
                },
            ],
        };
    };
    ...
    const data2 = (canvas) => {
        ...
        gradientStroke2.addColorStop(1, "rgba(0,40,200,0.68)");
        gradientStroke2.addColorStop(0.4, "rgba(0,40,200,0.63)");
            ...
            datasets: [
                {
                    ...
                    pointHoverBorderWidth: 15,
                    pointRadius: 2,
                    data: [400, 400, 800, 400, 500, 100, 500, 300, 1078, 100, 110, 100],
                },
            ],
        };
    };
